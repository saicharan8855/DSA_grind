...
def top\_k\_frequent\_naive(nums, k):
...
&#x20;   sorted\_keys = sorted(freq, key=lambda x: freq\[x], reverse=True)



&#x20;   # Step 3: return top k

&#x20;   return sorted\_keys\[:k]
...
def top\_k\_frequent\_optimal(nums, k):
...
To check your understanding: if `nums = \[4,4,4,5,5,6]` and `k = 1`, how would the buckets look (just conceptually), and which bucket index would give you the answer?
